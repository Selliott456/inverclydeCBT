      ...
      <div className="willContent">
        <section className="willImage">
          <p className="questionPara">
            ...
            <br></br>
            <br></br>
            CBT is evidence-based, which means we know it works! The approach is
            individualised and collaborative meaning the client feels empowered
            with regards to their treatment and progress.
          </p>
